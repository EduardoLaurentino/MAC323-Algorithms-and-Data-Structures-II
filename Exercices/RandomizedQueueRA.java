...
public class RandomizedQueueRA<Item> implements Iterable<Item>{
	private Item[] a;
	private int N;

	//construtor
	public RandomizedQueueRA(){
	...
	public Iterator<Item> iterator(){
		return new RandomizedQueueRAIterator();
	}

	private class RandomizedQueueRAIterator implements Iterator<Item>{
		private int current = 0;
				private Item[] b;

				public RandomizedQueueRAIterator(){
					b = a.clone();
					Randoming(b);
				}
